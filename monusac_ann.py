'''
This script converts monusac labels to inst_map and type_map
...
ann_dir = r"\\babyserverdw3\PW Cloud Exp Documents\Lab work documenting\W-22-09-02 AT Establish HoverNet Training with freezing weights\dataset\MoNuSAC\Train\Labels"
                ...
                for child in root[k]:
                    for x in child:
                        ...
                        if r == 'Region':
                            ...
                            binary_mask[fill_row_coords, fill_col_coords] = class_type
