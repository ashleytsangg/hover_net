...
class Config(object):
    ...
    def __init__(self):
        ...
        self.train_dir_list = [
            r"\\babyserverdw3\PW Cloud Exp Documents\Lab work documenting\W-22-09-02 AT Establish HoverNet Training with freezing weights\dataset\training_data\lymph_split_0\lymph\train\540x540_164x164"
        ]
        self.valid_dir_list = [
