...
class Config(object):
    ...
    def __init__(self):
        ...
        self.dataset_name = "ycsim" # extracts dataset info from dataset.py
        self.log_dir = "logs/" # where checkpoints will be saved

        # paths to training and validation patches
        self.train_dir_list = [
            r"\\babyserverdw3\PW Cloud Exp Documents\Lab work documenting\W-22-09-02 AT Establish HoverNet Training with freezing weights\dataset\training_data\ycsim\ycsim\train\540x540_164x164"
        ]
        self.valid_dir_list = [
            r"\\babyserverdw3\PW Cloud Exp Documents\Lab work documenting\W-22-09-02 AT Establish HoverNet Training with freezing weights\dataset\training_data\monusac_sub\monusac\valid\540x540_164x164"
        ]
